  ...
  return (
    <div className="px-4 sm:px-8 py-8 w-full max-w-2xl">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-bold text-neutral-900">New Catalogue Item</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-white rounded-xl border border-neutral-200 p-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. Safety Helmet Type I"
        ...
        <div className="bg-white rounded-xl border border-neutral-200 p-6">
          ...
          <p className="text-xs text-neutral-400 mt-2">Press Enter or click Add. E.g. CE, EN ISO 20345, ANSI Z87.1</p>
        </div>
