...
const brandDetails: Record<string, { name: string; content: string[] }> = {
  ...
  superon: {
    ...
    content: [
      ...
      "Standards: Superon has all international standard welding approvals such as AWS (American Welding Standard), ABS (American Bureau of Shipping), welding bureau veritas approval (BV), TUV Rheinland, CE approval, LRS approval, DB approval, CWB Canadian welding bureau, LLoyds registrar."
    ]
  },
  tempindic: {
    name: "TEMPINDIC",
    content: [
      "VPL Chemicals Pvt. Ltd. is one of the pioneers in the manufacturing and distributing of Temperature Indicating Crayons / Labels / Sensors / Liquid and Metal Markers etc. VPL is also into the manufacturing of Bulk drugs and API.",
